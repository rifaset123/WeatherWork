...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun startOneTimeTask() {
        ...
        // menjalankan task sekali
        val oneTimeWorkRequest = OneTimeWorkRequest.Builder(MyWorker::class.java)
            .setInputData(data)
            .setConstraints(constraints) // memberikan syarat kapan task ini dieksekusi,
            .build()
    ...
    private fun startPeriodicTask() {
        ...
        // menjalankan task secara periodic
        ...
        workManager.getWorkInfoByIdLiveData(periodicWorkRequest.id) // membaca status secara live
            .observe(this@MainActivity) { workInfo ->
                val status = workInfo.state.name
                binding.textStatus.append("\n" + status)
